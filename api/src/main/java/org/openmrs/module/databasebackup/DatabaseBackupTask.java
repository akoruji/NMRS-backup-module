...
public class DatabaseBackupTask extends AbstractTask {
    ...
    public void execute() {
        ...
        // Retrieve the facility_datim_code from the globalproperty table
	String facilityDatimCode = (String) Context.getAdministrationService().getGlobalProperty("facility_datim_code");

	// Generate the filename with the facility_datim_code and timestamp
	filename = facilityDatimCode + "_"
